...
namespace LibMtpSharpStandardMacOS.Usb
{
    ...
    public partial class UsbDevice
    {
        ...
        public bool SupportsDetachKernelDriver() => 
            UsbLibrary.HasCapability((uint)Capability.SupportsDetachKernelDriver) != 0;
        ...
        {
            EnsureOpen();
            return UsbLibrary.KernelDriverActive(DeviceHandle, interfaceNumber).GetValueOrThrow() == 1;
        }
        ...
        /// <see cref="UsbError.NotFound"/> <see cref="UsbException"/>
        /// </remarks>
        ...
        {
            EnsureOpen();
            UsbLibrary.DetachKernelDriver(DeviceHandle, interfaceNumber).ThrowOnError();
        }
        ...
        {
            EnsureOpen();
            UsbLibrary.AttachKernelDriver(DeviceHandle, interfaceNumber).ThrowOnError();
        }
        ...
        {
            EnsureOpen();
            return UsbLibrary.SetAutoDetachKernelDriver(DeviceHandle, autoDetach ? 1 : 0) == UsbError.Success;
        }
    }
}