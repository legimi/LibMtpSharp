...
namespace LibMtpSharpStandardMacOS.NativeAPI
{
    ...
    internal partial class LibMtpLibrary
    {
        ...
        private static extern int LIBMTP_Get_Supported_Filetypes(IntPtr mtpDeviceStructPointer, ref IntPtr filetypes,
            ref ushort length);

        public static int
            GetSupportedFiletypes(IntPtr mtpDeviceStructPointer, ref IntPtr filetypes, ref ushort length) =>
            LIBMTP_Get_Supported_Filetypes(mtpDeviceStructPointer, ref filetypes, ref length);
        ...
        public static int PopulateStorages(IntPtr mtpDeviceStructPointer) =>
            LIBMTP_Get_Storage(mtpDeviceStructPointer, 0);
        ...
        /// <returns></returns>
        [DllImport(LibMtpName, CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr LIBMTP_Get_Files_And_Folders(IntPtr mtpDeviceStructPointer, uint storageId,
            uint parentId);
        ...
        public static IntPtr GetParentContent(IntPtr mtpDeviceStructPointer, uint storageId, uint parentId) =>
            LIBMTP_Get_Files_And_Folders(mtpDeviceStructPointer, storageId, parentId);
        ...
        public static uint CreateFolder(IntPtr mtpDeviceStructPointer, string name, uint parentId, uint storageId) =>
            LIBMTP_Create_Folder(mtpDeviceStructPointer, Encoding.UTF8.GetBytes(name), parentId, storageId);

        [DllImport(LibMtpName, CallingConvention = CallingConvention.Cdecl)]
        private static extern int LIBMTP_Send_File_From_File(IntPtr device,
            byte[] path,
            ref FileStruct filedata,
        ...
        public static int SendFile(IntPtr device, string path, ref FileStruct fileData, ProgressFunction? callback,
            IntPtr data) =>
            LIBMTP_Send_File_From_File(device, Encoding.UTF8.GetBytes(path), ref fileData, callback, data);
        ...
        public static int DeleteObject(IntPtr device, uint objectId) => LIBMTP_Delete_Object(device, objectId);
        ...
        public static IntPtr GetFolderListForStorage(IntPtr device, uint storageId) =>
            LIBMTP_Get_Folder_List_For_Storage(device, storageId);
        ...
        public static IntPtr GetFolderList(IntPtr device) => LIBMTP_Get_Folder_List(device);
        ...
        public static void DestroyFolder(IntPtr folder) => LIBMTP_destroy_folder_t(folder);
        ...
        public static IntPtr GetFilelistingWithCallback(IntPtr device, ProgressFunction? callback) =>
            LIBMTP_Get_Filelisting_With_Callback(device, callback, IntPtr.Zero);
        ...
        [DllImport(LibMtpName, CallingConvention = CallingConvention.Cdecl)]
        private static extern int LIBMTP_Get_File_To_File(IntPtr device,
            uint id,
            byte[] path,
        ...
        public static int GetFileToFile(IntPtr device, uint id, string filePath, ProgressFunction? progressCallback) =>
            LIBMTP_Get_File_To_File(device, id, Encoding.UTF8.GetBytes(filePath), progressCallback, IntPtr.Zero);
        ...
        [DllImport(LibMtpName, CallingConvention = CallingConvention.Cdecl)]
        private static extern int LIBMTP_Get_File_To_Handler(IntPtr device, uint id, MtpDataPutFunction put_func,
            IntPtr priv,
            ProgressFunction? callback, IntPtr data);

        public static int GetFileToHandler(IntPtr device, uint id, MtpDataPutFunction putFunc,
            ProgressFunction? callback) =>
            LIBMTP_Get_File_To_Handler(device, id, putFunc, IntPtr.Zero, callback, IntPtr.Zero);
    }
}