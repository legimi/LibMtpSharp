...
namespace LibMtpSharpFrameworkMacOS.Structs
{
    ...
    internal struct AlbumNativeStruct
    {
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.LPUTF8Str)] public string? artist;

        /// <summary>
        /// Name of recording composer
        /// </summary>
        [MarshalAs(UnmanagedType.LPUTF8Str)] public string? composer;

        /// <summary>
        ///  Genre of album
        /// </summary>
        [MarshalAs(UnmanagedType.LPUTF8Str)] public string? genre;
